...
function scene:create( event )
    ...
    bkg_image = display.newImageRect("Images/InstructionsScreenTaishaunJ@2x-Recovered.png", display.contentWidth, display.contentHeight)
...
function scene:hide( event )
    ...
    if ( phase == "will" ) then
        ...
        bkgMusicInstructionsChannel = audio.stop()
    -----------------------------------------------------------------------------------------
